...
{
    /// <inheritdoc />
    public partial class InitialIdentityAndDominio : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Cursos_Creditos", "Creditos > 0");
                    table.CheckConstraint("CK_Cursos_CupoMaximo", "CupoMaximo > 0");
                    table.CheckConstraint("CK_Cursos_Horario", "HorarioInicio < HorarioFin");
                });
